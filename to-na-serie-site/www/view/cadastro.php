...
if ($p)
{
	...
	$erro = CTUsuario::insertUpdateUsuario($con, null, $obj_usuario);
}
...
<head>
    ...
    <!--Título e favicon-->
    <title>Tô na Série - Cadastro</title>
</head>
<body>
	<div id="tudo">
		...
		<div class="container-fluid padding-top">
			<div class="row">
				...
				<div class="col-sm-8 col-sm-offset-2 panel panel-orange">
					<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" accept-charset="utf-8"  enctype="multipart/form-data" onsubmit="return validaFormCadastro();">
						...
						<div class="row">
							<h2 class="col-md-12 text-center">Cadastre-se e aproveite todos benefícios!</h2>
						</div>
					...
					<fieldset>
						...
						<div class="row">
							...
							<div class="form-group col-md-6">
								...
								<input onchange="campoIgual('Email')" id="eRepetirEmail" name="eRepetirEmail" type="email" class="form-control" value="<?php echo esta_setado($p, 'eRepetirEmail'); ?>" required>
							</div>
						</div>
